        ...
        <div className="p-8 space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 disabled:opacity-50 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-200 shadow-sm"
                >
            ...
            {/* Verification Result */}
            {verification && (
                <div className={`border rounded-xl p-6 shadow-sm dark:shadow-none ${verification.valid
                    ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-700'
                    : 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-700'
                    }`}>
                    <div className="flex items-center gap-4">
                        <div className={`text-5xl ${verification.valid ? 'text-emerald-500 dark:text-emerald-400' : 'text-red-500 dark:text-red-400'}`}>
                            {verification.valid ? '✓' : '✗'}
                        </div>
                        <div>
                            ...
                            {verification.error && (
                                <p className="text-red-500 dark:text-red-400 mt-2">{verification.error}</p>
                            )}
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4 shadow-sm dark:shadow-none">
                ...
                <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4 shadow-sm dark:shadow-none">
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Chain Status</p>
                ...
                <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4 shadow-sm dark:shadow-none">
                    <p className="text-gray-500 dark:text-gray-400 text-sm">First Event</p>
                    <p className="text-lg font-medium text-gray-900 dark:text-white">
                        {report?.first_event ? formatTime(report.first_event).split(',')[0] : '—'}
                    </p>
                </div>
                <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4 shadow-sm dark:shadow-none">
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Last Event</p>
                    <p className="text-lg font-medium text-gray-900 dark:text-white">
                ...
                <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm dark:shadow-none">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {Object.entries(report.event_counts).map(([type, count]) => (
                            <div key={type} className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border border-gray-100 dark:border-gray-800">
            ...
            {report?.last_hash && (
                <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm dark:shadow-none">
                    ...
                    <code className="block w-full bg-gray-50 dark:bg-gray-900 p-4 rounded-lg font-mono text-sm text-cyan-600 dark:text-cyan-400 overflow-x-auto border border-gray-200 dark:border-gray-800">
                        {report.last_hash}
                    </code>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            ...
                            <tbody className="text-gray-700 dark:text-gray-300">
                                {events.map((event) => (
                                    <tr key={event.audit_id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/30">
            ...
            <div className="flex justify-end">
                <a
                    ...
                    className="bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white border border-gray-200 dark:border-transparent px-4 py-2 rounded-lg font-medium transition-colors shadow-sm"
                >
                    📥 Export Audit Log
                </a>
            </div>
