...
import { Plus, Save, RefreshCw, Sliders, ListTree, History, Search as SearchIcon, AlertCircle, Table2, GitCompareArrows, Users, Link2, RotateCcw } from "lucide-react";
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-wrap justify-between items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Blocking &amp; Scoring Rules</h1>
            ...
            {/* Step 1: Fields -- what's actually in the source data */}
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="font-semibold text-gray-900 dark:text-white">Step 1 · Fields</h2>
                </div>
                <FieldsPanel
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="glass-card p-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="font-semibold text-gray-900 dark:text-white">Step 2 · Blocking Rules</h2>
                    ...
                    <p className="text-[11px] text-gray-400 mt-2">
                        Every field is listed in Step 1 above with its explosion-risk check -- pick any of them here to block on it.
                    </p>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="glass-card p-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="font-semibold text-gray-900 dark:text-white">Step 3 · Matching &amp; Confidence</h2>
                    </div>
                    {matchRuleset && (
                        <ConfidencePanel
                    ...
                    <p className="text-[11px] text-gray-400 mt-2">
                        Any field can count toward a match, not just the 6 above -- e.g. mother's name, cousin's
                        name, or any field added to the source later. New fields start at 0% until you set a weight.
                    </p>
                </motion.div>

                {/* Segments: Company vs Individual */}
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.06 }} className="glass-card p-6">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="p-2 rounded-lg bg-blue-100 dark:bg-blue-500/20">
                            <Users size={20} className="text-blue-600 dark:text-blue-400" />
                        </div>
                        <h2 className="font-semibold text-gray-900 dark:text-white">Step 4 · Companies vs. Individuals</h2>
                    </div>
                    {segmentation && (
                        <SegmentsPanel
                            config={segmentation}
                ...
                {/* Connections: traceable cross-segment links */}
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.07 }} className="glass-card p-6">
                    <div className="flex items-center gap-3 mb-4">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }} className="glass-card p-6 lg:col-span-2">
                    <div className="flex items-center gap-3 mb-4">
